...
regional outcomes
(\hyperref[effectiveness_Global]{Figs.~\ref*{effectiveness_Global}}--\ref*{effectiveness_Western_Europe}).
...
\begin{figure}
  \begin{center}
    \input{../src/plots/transmission_rate.pgf}
  \end{center}
...
%\bibliographystyle{pnas-jm}
% The reference list was hand editted!
\input{\jobname.bbl}
...
\input{../src/plots/effectiveness_all/all}
