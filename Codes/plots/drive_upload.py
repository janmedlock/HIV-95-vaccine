...
files = (
    ...
    'effectiveness.pdf',
    'effectiveness.png',
    'effectiveness_samples_all.pdf',
    'effectiveness_samples.pdf',
    'effectiveness_samples.png',
    'effectiveness_samples_Status_Quo.pdf',
    'effectiveness_samples_Status_Quo.png',
    'effectiveness_samples_95–95–95.pdf',
    'effectiveness_samples_95–95–95.png',
