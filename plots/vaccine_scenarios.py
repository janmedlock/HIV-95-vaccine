...
def plot_some(treatment_target = model.target.StatusQuo()):
    ...
    axes[0, 1].yaxis.set_major_locator(ticker.MultipleLocator(250))
    axes[0, 2].yaxis.set_major_locator(ticker.MultipleLocator(50))
    axes[0, 2].set_ylim(top = 200)
