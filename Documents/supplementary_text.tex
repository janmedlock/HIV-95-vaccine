...
country-specific incidence and prevalence data
...
88 [XX, YY] days \cite{Hollingsworth2008-iy}. We assumed that people
remain undiagnosed during their acute infection phase and during at
least some of the subsequent period of clinical latency (i.e., the
undiagnosed compartment). After acute infection, people move into the
chronic undiagnosed class ($U$).  People in the undiagnosed class will
be diagnosed at a rate determined by the country's initial diagnosis
level and potential progress towards the UNAIDS targets.  Diagnosed
people (compartment $D$) transition to the treated compartment ($T$)
upon starting ART at a rate of $\phi$ , and then to the
viral-suppression class ($V$) after achieving viral suppression
through treatment retention at a rate of $\gamma$. The disengagement
from treatment moves people from treated ($T$) and viral suppression
($V$) at a rate of $\omega$ back to the diagnosed class ($D$). Rates
of movement between the undiagnosed ($U$), diagnosed ($D$), treated
($T$) and viral-suppression classes ($V$) are determined by the
proportions of PLHIV diagnosed ($p_{D}$), proportion of diagnosed
people on ART ($p_{T}$), and the proportion of people on ART who have
achieved viral suppression ($p_{V}$). PLHIV in $U$, $D$, $T$, and $V$
classes develop AIDS (compartment $W$) after an average duration
dependent on viral suppression status. People who have achieved viral
suppression ($V$) take longer to develop AIDS ($1/\theta$), than those
who are in the other PLHIV classes ($1/\sigma$). People who are
susceptible to HIV are vaccinated at rate $\zeta$, transitioning into
the vaccinated compartment ($R$), where the vaccine reduces their
force of infection by the efficacy factor $\rho$.  The model equations
are
\begin{equation}
  \label{model_eqns}
  \begin{split}
...
\begin{equation}
  ...
  \end{split}
\end{equation}
The rate of developing AIDS among those who have acheived viral
suppression is
\begin{equation}
...
\end{equation}
the proportion with viral suppression is
\begin{equation}
  p_V = \frac{V}{T + V},
\end{equation}
and the proportion of people vaccinated is
\begin{equation}
  P_{V} = \frac{R}{S+R}.
\end{equation}
...
The rates are applied when the proportions of $p_D$, $p_T$, and $p_V$
...
We calculated partial rank correlation coefficients (PRCC) \cite{}
to measure the independent effect of each parameter on model
projections of HIV incidence (\autoref{PRCCs}). Furthermore, due to
uncertainty surrounding the prospective vaccine, we obtained model
projections using six additional vaccine scenarios by considering
alternative estimates of efficacy (30\%, 70\%), coverage (50\%, 90\%),
speed of scale up (10\% coverage per year), and first year of
availability (2025).
